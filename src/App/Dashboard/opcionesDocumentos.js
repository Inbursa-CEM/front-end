...
const OpcionesDocumentos = () => {
  ...
  const {
    llamadasPromAgente,
    promedioProbResAgente,
    velPromRespuesta,
    promServicio,
    duracionPromLlamadas,
    numLlamadasAtendidas,
    totalProbResueltos,
  } = opciones;
      ...
      <FormControl component="fieldset">
        ...
        <FormGroup>
          <FormControlLabel
            control={
              <Checkbox
                checked={llamadasPromAgente}
                onChange={handleOpciones}
                name="llamadasPromAgente"
              />
            }
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={promedioProbResAgente}
                onChange={handleOpciones}
                name="promedioProbResAgente"
              />
            }
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={velPromRespuesta}
                onChange={handleOpciones}
                name="velPromRespuesta"
              />
            }
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={duracionPromLlamadas}
                onChange={handleOpciones}
                name="duracionPromLlamadas"
              />
            }
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={numLlamadasAtendidas}
                onChange={handleOpciones}
                name="numLlamadasAtendidas"
              />
            }
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={totalProbResueltos}
                onChange={handleOpciones}
                name="totalProbResueltos"
              />
            }
